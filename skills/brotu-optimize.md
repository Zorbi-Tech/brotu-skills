...
- **Nano Banana 2** supports reference images — for image-to-image, describe what should *change*, not the full scene: `Mesma composição da referência, mas com iluminação dramática ao entardecer`
- **Nano Banana Pro** rewards high specificity — push detail on lighting, texture, atmosphere:
  - `luz Rembrandt lateral com highlight dourado e sombra azulada suave`
  - `névoa de manhã cedo filtrando raios de luz entre as árvores`
